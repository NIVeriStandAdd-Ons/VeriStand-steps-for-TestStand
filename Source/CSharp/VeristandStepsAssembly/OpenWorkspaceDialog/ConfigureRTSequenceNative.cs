...
{
    public partial class ConfigureRTSequenceNative : Form
    {
       public const int maxNumberOfSequences = 100;
        ...
        public ConfigureRTSequenceNative(SequenceContext _seqContext)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                sequenceFileExp = stepPropertyObject.GetValVariant("Veristand.SequenceFilePath", 0);
                ...
                try
                {
                    ...
                    //Populate the existing timeout value
            ...
            catch (Exception ex)
            {
                ...
                //DEBUG, squishing all init exceptions
            }
        }
