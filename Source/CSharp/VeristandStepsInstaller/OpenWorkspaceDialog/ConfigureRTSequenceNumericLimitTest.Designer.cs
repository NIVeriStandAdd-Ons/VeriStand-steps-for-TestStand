...
{
    partial class ConfigureRTSequenceNumericLimit
    {
        /// <summary>
        ...
        void InitializeTableView(SequenceContext _seqContext,string fileExp,string[] _parameterValues,string[] _parameterTypes, bool reset)
        {
            ...
            this.OpenSelectSingleChannelsDialog = new SelectSingleChannelPanelNumLimit(this);
            ...
            if (filePath != null && filePath != "" && System.IO.File.Exists(filePath))  //Don't try to initialize with a blank filepath
            {
                try
                {
                    ...
                    string returnParamName = returnParam.Identifier;
                    string returnParamType = returnParam.DataType.ToString();
                    returnParamDataType = returnParamType;
                    this.returnParameterTextBox1.Text = returnParamDataType;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ConfigureRTSequenceNumericLimit));
            ...
            this.returnParameterTextBox1 = new System.Windows.Forms.TextBox();
            this.returnVariableDataTypeLabel1 = new System.Windows.Forms.Label();
            ...
            // 
            // returnParameterTextBox1
            // 
            this.returnParameterTextBox1.BorderStyle = System.Windows.Forms.BorderStyle.None;
            resources.ApplyResources(this.returnParameterTextBox1, "returnParameterTextBox1");
            this.returnParameterTextBox1.Name = "returnParameterTextBox1";
            this.returnParameterTextBox1.ReadOnly = true;
            this.returnParameterTextBox1.TabStop = false;
            // 
            // returnVariableDataTypeLabel1
            // 
            resources.ApplyResources(this.returnVariableDataTypeLabel1, "returnVariableDataTypeLabel1");
            this.returnVariableDataTypeLabel1.Name = "returnVariableDataTypeLabel1";
            // 
            // label1
            // 
            ...
            // 
            // ConfigureRTSequenceNumericLimit
            // 
            ...
            this.Controls.Add(this.returnVariableDataTypeLabel1);
            this.Controls.Add(this.returnParameterTextBox1);
            ...
            this.Name = "ConfigureRTSequenceNumericLimit";
        ...
        public SelectSingleChannelPanelNumLimit OpenSelectSingleChannelsDialog;
        private Panel panel1;
        private AxExpressionEdit FilePath;
        private Panel panel2;
        private TextBox returnParameterTextBox1;
        private Label returnVariableDataTypeLabel1;
