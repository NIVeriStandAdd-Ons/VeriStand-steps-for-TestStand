...
node{
    ...
    stage("vs2015sp1_ts2014_x86"){
        ...
        installer_build_dest="veristand2015sp1-teststand2014-x86-15.1.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2015\\NI VeriStand.exe"
        x64_build_flag=false
        
        veristandStepsPipeline(branch, org, veristand_version, teststand_version, x64_build_flag, types_version, veristand_assembly_version, veristand_gac_assembly_version, teststand_pub_docs_install_dir, teststand_assembly_version, installer_build_dest, lv_version, vs_install_path)
    }
    ...
    stage("vs2016_ts2014_x86"){
        ...
        teststand_assembly_version="14.0.0.103"
        teststand_pub_docs_install_dir="TestStand 2014 (32-bit)"
        installer_build_dest="veristand2016-teststand2014-x86-16.0.6.0"
    ...
    stage("vs2017_ts2014_x86"){
        ...
        teststand_assembly_version="14.0.0.103"
        teststand_pub_docs_install_dir="TestStand 2014 (32-bit)"
        installer_build_dest="veristand2017-teststand2014-x86-17.0.6.0"
    ...
    stage("vs2015sp1_ts2016_x86"){
        ...
        installer_build_dest="veristand2015sp1-teststand2016-x86-15.1.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2015\\NI VeriStand.exe"
        x64_build_flag=false
    ...
    stage("vs2016_ts2016_x86"){
        ...
        teststand_assembly_version="16.0.0.185"
        teststand_pub_docs_install_dir="TestStand 2016 (32-bit)"
        installer_build_dest="veristand2016-teststand2016-x86-16.0.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2016\\NI VeriStand.exe"
        x64_build_flag=false
    ...
    stage("vs2017_ts2016_x86"){
        ...
        teststand_assembly_version="16.0.0.185"
        teststand_pub_docs_install_dir="TestStand 2016 (32-bit)"
        installer_build_dest="veristand2017-teststand2016-x86-17.0.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2017\\NI VeriStand.exe"
        x64_build_flag=false
	...
	stage("vs2015sp1_ts2016_x64"){
        ...
        installer_build_dest="veristand2015sp1-teststand2016-x64-15.1.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2015\\NI VeriStand.exe"
        x64_build_flag=true
	...
	stage("vs2016_ts2016_x64"){
        ...
        teststand_assembly_version="16.0.0.103"
        teststand_pub_docs_install_dir="TestStand 2016 (64-bit)"
        installer_build_dest="veristand2016-teststand2016-x64-16.0.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2016\\NI VeriStand.exe"
        x64_build_flag=true
	...
	stage("vs2017_ts2016_x64"){
        ...
        teststand_assembly_version="16.0.0.103"
        teststand_pub_docs_install_dir="TestStand 2016 (64-bit)"
        installer_build_dest="veristand2017-teststand2016-x64-17.0.6.0"
        vs_install_path="C:\\Program Files (x86)\\National Instruments\\VeriStand 2017\\NI VeriStand.exe"
        x64_build_flag=true
